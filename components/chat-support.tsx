...
export function ChatSupport({ language }: ChatSupportProps) {
  ...
  const getBotResponse = (userMessage: string): string => {
    ...
    // Default response
    return language === "de"
      ? "Entschuldigung, ich habe Ihre Frage nicht verstanden. Können Sie sie anders formulieren? Für spezifische Kontoanfragen melden Sie sich bitte zuerst an."
      : "I'm sorry, I didn't understand your question. Could you rephrase it? For specific account inquiries, please sign in first."
  }
